...
const Email = ({ name, editorUrl }: Props) => (
  <Html lang="de" dir="ltr">
    <Head />
    <Preview>Willkommen bei myCVonline — erstelle jetzt deinen Lebenslauf</Preview>
    <Body style={main}>
      <Container style={container}>
        <Heading style={heading}>Willkommen bei myCVonline</Heading>
        <Text style={text}>{name ? `Hallo ${name},` : "Hallo,"}</Text>
        <Text style={text}>
          schön, dass du da bist! Mit myCVonline erstellst du in wenigen Minuten einen
          professionellen Lebenslauf — in 7 Sprachen, mit KI-Unterstützung und
          hochwertigen Vorlagen.
        </Text>
...
export const template = {
  component: Email,
  subject: "Willkommen bei myCVonline",
